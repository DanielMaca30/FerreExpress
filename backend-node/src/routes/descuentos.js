...
const { listarReglas, crearRegla, actualizarRegla, eliminarRegla, listarReglasActivas } = require('../controllers/descuentosController');

router.get('/descuentos/activas', requireAuth, requireRole('CONTRATISTA'), listarReglasActivas);
