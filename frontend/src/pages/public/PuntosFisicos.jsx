...
export default function PuntosFisicos() {
  ...
  const jsonLd = useMemo(
    () => ({
      ...
      description:
        "Punto físico de FerreExpress para retiro de pedidos y atención al cliente.",
    }),
    []
  );
  ...
  const onShare = async () => {
    const shareData = {
      ...
      text: "Punto físico FerreExpress",
      url: mapsSearchUrl,
    };
    try {
      if (navigator.share) {
        ...
        toast({
          ...
          description: "Pegalo donde quieras compartir.",
          status: "info",
          duration: 2000,
          isClosable: true,
        });
    ...
    <Box bg={pageBg} px={{ base: 3, md: 6, lg: 10 }} py={{ base: 4, md: 6 }}>
      ...
      >
        <VStack align="start" spacing={3}>
          ...
          <Text color={fgMuted}>
            Visítanos para asesoría, retiro de pedidos y atención al cliente.
          </Text>
          <HStack spacing={2} flexWrap="wrap">
            ...
            <Button
              ...
              variant="outline"
              onClick={() => window.open(mapsDirUrl, "_blank", "noopener")}
            >
              Cómo llegar
            </Button>
            <Tooltip label="Abrir en Waze">
              <Button
                ...
                variant="ghost"
                onClick={() => window.open(wazeUrl, "_blank", "noopener")}
              >
                Waze
              </Button>
            </Tooltip>
          ...
          <Box flex={{ md: "0 0 380px" }} p={{ base: 4, md: 5 }}>
            <VStack align="start" spacing={3}>
              <Box
                ...
                borderTopRadius="xl"
                _hover={{ boxShadow: "md" }}
                // deja ~4px de aire respecto al top del card (p: 4/5)
                mt={{ base: -3, md: -4 }}
                mx={0} // ← sin desplazar a la izquierda
                mb={3}
                cursor="pointer"
                onClick={() => window.open(mapsSearchUrl, "_blank", "noopener")}
          ...
          >
            <AspectRatio ratio={16 / 9} w="100%">
              <Box
                ...
                loading="lazy"
                border={0}
                aria-label="Mapa con la ubicación del punto físico de FerreExpress"
              />
            </AspectRatio>
          </Box>
        </HStack>
