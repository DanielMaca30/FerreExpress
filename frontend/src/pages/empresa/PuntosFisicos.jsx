...
const ADDRESS_TEXT =
  "Calle 16 #76-28, Prados del Limonar, Cali, Valle del Cauca, Colombia";

export default function EmpresaPuntosFisicos() {
  ...
  const jsonLd = useMemo(
    () => ({
      ...
      description:
        "Punto físico de FerreExpress para retiro de pedidos, atención a contratistas y clientes empresariales.",
    }),
    []
  );
  ...
  const onShare = async () => {
    const shareData = {
      title: "FerreExpress – Punto físico",
      text: "Punto físico FerreExpress para retiro de pedidos y atención a empresas.",
      url: mapsSearchUrl,
    };
    try {
      if (navigator.share) await navigator.share(shareData);
        ...
        toast({
          ...
          description: "Pégalo donde quieras compartir.",
          status: "info",
          duration: 2000,
          isClosable: true,
        });
      ...
      // usuario canceló compartir, no hacemos nada
    }
  };
      ...
      >
        <VStack align="start" spacing={3}>
          <Badge colorScheme="teal" borderRadius="full" px={3} py={1}>
            Puntos físicos • Empresas
          </Badge>
          <Heading size={{ base: "lg", md: "xl" }}>
            Nuestro punto físico en Cali
          </Heading>
          <Text color={fgMuted}>
            Visítanos para asesoría técnica, retiro de pedidos empresariales y
          ...
          <HStack spacing={2} flexWrap="wrap">
            ...
            <Tooltip label="Copiar dirección">
              <Button leftIcon={<FiCopy />} variant="ghost" onClick={onCopy}>
                Copiar
              </Button>
            </Tooltip>
            <Tooltip label="Compartir">
              <Button leftIcon={<FiShare2 />} variant="ghost" onClick={onShare}>
                Compartir
              </Button>
            </Tooltip>
          </HStack>
        ...
        >
            ...
            <VStack align="start" spacing={3}>
              ...
              >
                <AspectRatio ratio={{ base: 16 / 9, md: 21 / 9 }}>
                  <Image
                    src="/LogoPequeño.jpg" // asegúrate que exista en /public
                ...
                <Box
                  position="absolute"
                  inset={0}
                  bgGradient="linear(to-t, blackAlpha.400 5%, transparent 60%)"
                  pointerEvents="none"
                />
              ...
              <VStack align="start" spacing={1} fontSize="sm" color={fgMuted}>
                <HStack>
                  ...
                  <Text>+</Text>
                  <Kbd>C</Kbd>
                  <Text>para copiar la dirección</Text>
                </HStack>
                <Text>
                  Único punto físico actualmente. Atención a clientes y
                  contratistas.
                </Text>
              </VStack>
              ...
              <Text fontSize="sm" color={fgMuted}>
                Sugerencia: al tocar “Cómo llegar”, Google Maps calculará la
                ruta desde tu ubicación actual.
              </Text>
            </VStack>
          </Box>
          ...
          >
            <AspectRatio ratio={16 / 9} w="100%">
              <Box
                as="iframe"
                title="Ubicación FerreExpress en Google Maps"
                src={iframeSrc}
                loading="lazy"
                border={0}
                aria-label="Mapa del punto físico"
              />
            </AspectRatio>
          </Box>
        </HStack>
