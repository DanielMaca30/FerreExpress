...
import {
    Box, Button, Heading, Text, VStack, HStack, FormControl, FormLabel, Input, IconButton, InputGroup, InputRightElement, Link, Divider, useToast, Progress, List, ListItem,
    ListIcon, Flex, Image, Container, Grid, GridItem, useColorModeValue, Modal, ModalOverlay, ModalContent, usePrefersReducedMotion
...
export default function RegisterEmpresa() {
    // 🎨 Esquema visual (igual al Login/Registro Cliente)
    ...
    // ====== Layout: fondo + logo + card + footer sticky (no tapa contenido) ======
    return (
                        ...
                        <form onSubmit={handleSubmit} noValidate>
                            <VStack spacing={4} align="stretch">
                                ...
                                <Text fontSize="xs" color="gray.600" textAlign="left">
                                    ...
                                    <Link color="blue.400" textDecoration="underline">Condiciones de uso</Link>{" "}
                                    y el{" "}
                                    <Link color="blue.400" textDecoration="underline">Aviso de privacidad</Link>{" "}
                                    de FerreExpress.
                                </Text>
